...
def run():
   ...
   # radius_range = np.linspace(0.06,0.12,radius_steps)
    ...
    radius_range = np.linspace(0.05,0.15,radius_steps)
   ...
   # w2 = np.linspace(0.0,1.0,weight_steps)
    ...
    path = 'C:\\Users\\Chris\\Dropbox\\Apps\\ShareLaTeX\\ICRA 2018 Move To See\\results\\sim_data\\experiment_varied_radius\\'
                ...
                #for occlusion_y in occlusion_range:
                    #for angle in orientation_range: 
                        #for noise_std in noise_range:
                            ...
                            mvs.setObjectiveFunctionWeights(w1,w2)

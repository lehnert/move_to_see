...
def run(trial_number, angle):
    ...
    mvs = move_to_see(9,"ROS",step_size=0.002, size_weight=1.0, manip_weight=0.0,end_tolerance=0.75,max_pixel=0.2)
    ...
    file_name = path + "real_robot"+ "_trial_"+str(trial_number) + "_" + str(angle) + "_" + time.strftime("%Y_%m_%d-%H_%M_%S")
